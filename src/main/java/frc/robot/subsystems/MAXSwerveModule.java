...
public class MAXSwerveModule {
  ...
  private final AnalogEncoder m_turningEncoder;  // UPDATED
  ...
  public MAXSwerveModule(int drivingCANId, int turningCANId, int analogChannel, double chassisAngularOffset) {
    ...
    // Initialize analog encoder with full range of 2 PI radians
    m_turningEncoder = new AnalogEncoder(analogChannel, 2 * Math.PI, 0);
